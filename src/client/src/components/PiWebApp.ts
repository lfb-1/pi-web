...
export class PiWebApp extends LitElement {
  ...
  private async forkAssistantResponse(entryId: string): Promise<void> {
    await this.sessions.forkFromMessage(entryId);
  }
